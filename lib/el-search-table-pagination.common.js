...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_20b35f8b_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(11);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_20b35f8b_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["a" /* default */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6d37fc5a_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(12);
var normalizeComponent = __webpack_require__(0)
/* script */
...
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6d37fc5a_hasScoped_false_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
  ...
  watch: {
    params: {
      handler: function handler(val, oldval) {
        ...
        setTimeout(function () {
          _this2.$refs.submitButton.$el.click();
        }, 50);
      },
  ...
  methods: {
    ...
    searchHandler: function searchHandler() {
      ...
      this.getParams(function (error, params) {
        if (!error) {
          var submitHandler = _this3.submitHandler;
    ...
    getRemoteData: function getRemoteData(_ref) {
      ...
      fetch().then(function (response) {
        var result = response;
        if ((typeof response === "undefined" ? "undefined" : _typeof(response)) === "object" && !_this5.isArray(response)) {
        ...
        if (_this5.resultHandler) {
          _this5.selectOptions[dataKey] = result.map(_this5.resultHandler);
        } else {
          _this5.selectOptions[dataKey] = result;
        }
      });
    }
  }
